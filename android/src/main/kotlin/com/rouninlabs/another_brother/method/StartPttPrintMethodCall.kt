...
/**
 * Command for startPttPrint to a Brother printer.
 * This support both one-time as well as the standard openCommunication/print/closeCommunication
 * approach.
 */
class StartPttPrintMethodCall(val flutterAssets: FlutterPlugin.FlutterAssets, val context: Context, val call: MethodCall, val result: MethodChannel.Result) {
    companion object {
        const val METHOD_NAME = "startPTTPrint"
    }
    ...
    fun execute() {
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            val key:Int = call.argument<Int>("key")!!
            val encode:String = call.argument<String>("encode")!!
