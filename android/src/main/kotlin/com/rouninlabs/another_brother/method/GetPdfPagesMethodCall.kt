 ...
 * approach.
 */
class GetPdfPagesMethodCall(val flutterAssets: FlutterPlugin.FlutterAssets, val context: Context, val call: MethodCall, val result: MethodChannel.Result) {
    companion object {
    ...
    fun execute() {
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            try {
                ...
                Log.e("GetPdfPages", "NPE during get operation - likely SDK internal error", e)
                withContext(Dispatchers.Main) {
                    result.success(-1)
                }
            } catch (e: Exception) {
                Log.e("GetPdfPages", "Error during get operation", e)
                withContext(Dispatchers.Main) {
                    result.success(-1)
                }
            }
